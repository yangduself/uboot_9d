...
//lcd backlight control T34
#if 1
#if 0
	/*t34h lvds_pwr_down output: gph0_7 output 1*/

	Outp32(0xe0200c00, ((Inp32(0xe0200c00) & (~(0xf << 28))) |(0x01 << 28)));

	Outp32(0xe0200c04, (Inp32(0xe0200c04) | (0x80)));


	
	Outp32(0xe02000a0,((Inp32(0xe02000a0)&(~((0xf << 0)|(0xf << 4)|(0xf << 8))))|(0x1 << 0)|(0x1 << 4)|(0x1 << 8)|(0x1<<12)));
	Outp32(0xe02000a8,Inp32(0xe02000a8)&(~((0x3 << 0)|(0x3 << 2)|(0x3 << 4)|(0x3 << 6))));
	Outp32(0xe02000a4,Inp32(0xe02000a4)|0xF);

#else /*use pwm control to backlight to reduce the current;*/

	/*t34h lvds_pwr_down output: gph0_7 output 1*/
	Outp32(0xe0200c00, ((Inp32(0xe0200c00) & (~(0xf << 28))) |(0x01 << 28)));
	Outp32(0xe0200c04, (Inp32(0xe0200c04) | (0x80)));
	Outp32(0xe02000a0,((Inp32(0xe02000a0)&(~((0xf << 0)|(0xf << 4)|(0xf << 8))))|(0x2 << 0)|(0x1 << 4)|(0x1 << 8)|(0x1<<12)));
	Outp32(0xe02000a8,Inp32(0xe02000a8)&(~((0x3 << 0)|(0x3 << 2)|(0x3 << 4)|(0x3 << 6))));
	Outp32(0xe02000a4,Inp32(0xe02000a4)|0xe);
	
	/*config the pwm control registers*/
	Outp32(0xe2500008,Inp32(0xe2500008) & (~(0x1))); //stop timer0
	Outp32(0xe2500000,(Inp32(0xe2500000) & (~(0xF)))|0x50); // prescaler to 80
	Outp32(0xe2500004,(Inp32(0xe2500004) & (~(0xF)))); // divider to 1
	//Outp32(0xe2500008,(Inp32(0xe2500008) & (~(0xF)))|0xD); 
	Outp32(0xe250000C,0x000086b);//Outp32(0xe250000C,0x000086b2);
	Outp32(0xe2500010,0x000024a);//Outp32(0xe2500010,0x000024ab);
	Outp32(0xe2500044,(Inp32(0xe2500044) & (~(0x1)))); 
	Outp32(0xe2500008,(Inp32(0xe2500008) & (~(0xF)))|0xe); //manual load
	Outp32(0xe2500008,(Inp32(0xe2500008) & (~(0xF)))|0xd);  //start timer0
#endif
...
//=// /**/
/*******************************************************************/
	Outp32(0xf8000100, 0x1558);//=// virtual screen offset 
	Outp32(0xf8000040, 0x0); //window 0 position control a register
	...
	Outp32(0xf8000020, 0x802d);//=//window 0 control register
	Outp32(0xf8000034, 0x1); // window shadow control register
...
//	Outp32(0xf8000000, 0x57); //===> MPLL should be 667 !!!!
	...
	Outp32(0xf8000010, 0xff160b01); //Video Time Control 0 Register
